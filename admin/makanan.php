...
$query = 'SELECT makanan.*, penjual.nama as nama_penjual FROM makanan INNER JOIN penjual ON makanan.id_penjual = penjual.id_penjual';
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right"><button class="btn btn-success btn-sm" onclick="addMakanan()"><i class="fa fa-plus-square-o"></i> Tambah</button></div>
                            </div>
                                ...
                                <table class="table ">
                                    ...
                                    <?php $i = 1;foreach ($rows as $row) :?>
                                        <tr>
                                            ...
                                            <td> <span class="product"><?= $row['stok']?></span> </td>
                                            <td> <span class="product"><?= $row['nama_penjual']?></span> </td>
