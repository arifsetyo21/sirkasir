...
include '../functions.php';
    ...
    $querySelectMeja = "SELECT * FROM meja WHERE id_meja = '$id_meja'";
    $result = mysqli_query($conn, $querySelectMeja);
                ...
                <div class="col-lg-10">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <!-- <?php  var_dump($row);?> -->
                                <form action="ubah-meja-proses.php" method="post" enctype="multipart/form-data"   class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="name-input" class=" form-control-label">Nama </label></div>
                                        <div class="col-12 col-md-9"><p><?php echo $row['id_meja'];?></p></div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="status" id="status-input" class="form-control">
                                                <option value="" disabled selected>Pilih Status Meja Saat Ini</option>
