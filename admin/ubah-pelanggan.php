                ...
                <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                <strong>Ubah Data</strong> Pelanggan
                            </div>
                            <div class="card-body card-block">
                                <form autocomplete="off" action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        <input type="text" name="id_pelanggan" value="<?= $id_pelanggan?>" hidden>
                                        <div class="col col-md-3"><label for="name-input" class=" form-control-label">Nama </label></div>
                                        <div class="col-12 col-md-9"><input required type="text" id="name-input" name="nama" value="<?= $pelanggan['nama']?>" placeholder="Enter Name" class="form-control" autocomplete="off" required><small class="help-block form-text">Please enter name</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="input" class=" form-control-label">Username </label></div>
                                        <div class="col-12 col-md-9"><input required type="text" id="panen-input" name="username" value="<?= $pelanggan['username']?>" placeholder="Enter Day to Common Harvest" class="form-control" required><small class="help-block form-text">Please enter harvest time </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="harga-input" class=" form-control-label">Password </label></div>
                                        <div class="col-12 col-md-9"><input required type="password" id="harga-input" name="password" value="<?= $pelanggan['password']?>" placeholder="Enter Market Prize" class="form-control" required><small class="help-block form-text">Please enter market price</small></div>
                                    </div>
                                    <div class="row form-group">
